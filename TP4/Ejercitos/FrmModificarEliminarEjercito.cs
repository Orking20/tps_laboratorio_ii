            ...
            if (FrmPrincipal.Ejercitos.Count > 0)
            {
                for (int i = 0; i < FrmPrincipal.Ejercitos.Count; i++)
                {
                    ...
                    if (this.nudId.Value == ejercito.Id)
                    {
                        ...
                        {
                            BaseDeDatos.Update(ejercito, this.txtNombre.Text, this.cmbNacion.Text, this.cmbTipo.Text, this.cmbAutonomia.Text, this.nudNumero.Value.ToString(), out error);
                            ...
                            else
                            {
                                ...
                                MessageBox.Show("Se ha modificado con éxito", "Modificación exitosa", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (FrmPrincipal.Ejercitos.Count > 0)
            {
                for (int i = 0; i < FrmPrincipal.Ejercitos.Count; i++)
                {
                    ...
                    if (this.nudId.Value == ejercito.Id)
                    {
                        BaseDeDatos.Delete(ejercito, out error);
                        ...
                        else
                        {
                            ...
                            MessageBox.Show("Se ha eliminado con éxito", "Eliminación exitosa", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            ReproducirSonidoExito();
                            break;
                        }
                    }
