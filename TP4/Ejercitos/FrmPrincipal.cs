...
namespace Ejercitos
{
    public partial class FrmPrincipal : Form
    {
        ...
        /// <summary>
        /// Abre el formulario para el análisis de datos de los ejércitos
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void btnAnalisis_Click_1(object sender, EventArgs e)
        {
            AbrirFormularioHijo(new FrmAnalisisDatos());
        }
        ...
        private void CargaDatos()
        {
            ...
            Ejercitos = BaseDeDatos.Select(out error);
        ...
        {
            if (!flagExportar && MessageBox.Show("No guardaste los cambios en los archivos .csv, .xml o .json. Asegurate de hacerlo en la sección 'Exportar'\nLos datos se guardan automaticamente solo en la base de datos\n¿Estás seguro que quieres salir?", "¿Desea salir?", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.No)
            {
                e.Cancel = true;
            }
        }
